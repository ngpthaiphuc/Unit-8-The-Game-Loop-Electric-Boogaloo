...
public class MoveBackAndForth : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        {
            startPositions.Add(currentObject.transform.position); // one of these lists needs this kind of position...
            endPositions.Add(currentObject.transform.position + new Vector3(0,0,10f)); // another one needs another...
        }
    }
